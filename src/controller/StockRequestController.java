...
public class StockRequestController {
  ...
  private void printDB(ArrayList<StockRequestDto> list){
    ...
    StockRequestList.forEach(stockrequest -> System.out.println(
        stockrequest.getId() + "\t\t\t" + stockrequest.getProductId() + "\t\t\t"
            + stockrequest.getBoxQuantity() + "\t\t\t" + stockrequest.getBoxSize() + "\t\t\t\t"
            + stockrequest.getStatus() + "\t\t\t" + stockrequest.getIncomingDate() + "\t\t\t"
  ...
  private void printRequestInstr(){
    ...
    StockRequestList.forEach(instr -> System.out.println(
        instr.getId() + "\t\t\t\t" + instr.getStockRequestId().orElse(null)+ "\t\t\t\t"
            + instr.getBoxQuantity() + "\t\t" + instr.getCreatedAt() + "\t"
            + instr.getLoadingInstr().orElse(null) + "\t\t\t" + instr.getRemarks() + "\t\t\t"));
