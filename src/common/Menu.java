...
public enum Menu {
    ...
    ADMIN_MEMBER_EDIT_MENU("1. 회원 정보 수정 | 2. 비밀번호 수정  3. 쇼핑몰 사업자 정보 수정\n"),
    ADMIN_MEMBER_PERMISSION_MENU("1. 직원 권한 | 2. 쇼핑몰 사업자 권한 승인\n"),
    ADMIN_DELETE_MENU("1. 직원 삭제 | 2. 쇼핑몰 사업자 회원 삭제\n"),
